    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        <p className="text-textColor text-lg">
         Experience nature's essence with FarmU. We deliver farm-fresh treasures, 
         cultivating health and taste, right to your home.  Discover the unparalleled taste of freshly harvested goodness,
         delivered straight to you, from our fields to your plate.
        </p>
        <motion.button
          {...buttonClcik}
